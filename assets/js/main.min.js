...
!(function (e, t) {
    ...
    function y(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (u /= 2, l = l || c[3], c = +u || 1; a--; )
                Ee.style(e, t, c + l), (1 - i) * (1 - (i = s() / u || 0.5)) <= 0 && (a = 0), (c /= i);
        ...
        for (var n, r, o = [], i = 0, a = e.length; a > i; i++)
            (r = e[i]),
                r.style &&
                    ((n = r.style.display),
                    t
                        ? ('none' === n && ((o[i] = ze.get(r, 'display') || null), o[i] || (r.style.display = '')),
    ...
    function O(e, t) {
        ...
        if (1 === t.nodeType) {
            if (ze.hasData(e) && ((i = ze.access(e)), (a = ze.set(t, i)), (l = i.events))) {
                ...
                for (o in l) for (n = 0, r = l[o].length; r > n; n++) Ee.event.add(t, o, l[o][n]);
            }
    ...
    function P(e, t, r, o) {
        ...
        if (
            d &&
            ((i = T(t, e[0].ownerDocument, !1, e, o)), (a = i.firstChild), 1 === i.childNodes.length && (i = a), a || o)
        ) {
            for (s = Ee.map(w(i, 'script'), L), u = s.length; d > f; f++)
                (l = i), f !== p && ((l = Ee.clone(l, !0, !0)), u && Ee.merge(s, w(l, 'script'))), r.call(e[f], l, f);
            if (u)
                    ...
                    (l = s[f]),
                        ot.test(l.type || '') &&
                            ...
                            (l.src && 'module' !== (l.type || '').toLowerCase()
                                ? Ee._evalUrl &&
                                  !l.noModule &&
                                  Ee._evalUrl(l.src, { nonce: l.nonce || l.getAttribute('nonce') })
    ...
    function q(e, t, n) {
        for (var r, o = t ? Ee.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
            n || 1 !== r.nodeType || Ee.cleanData(w(r)),
                r.parentNode && (n && Ke(r) && C(w(r, 'script')), r.parentNode.removeChild(r));
        return e;
    }
    function M(e, t, n) {
        var r,
            ...
            'margin' === n && (u += Ee.css(e, n + Ve[a], !0, o)),
                r
                    ? ('content' === n && (u -= Ee.css(e, 'padding' + Ve[a], !0, o)),
                      'margin' !== n && (u -= Ee.css(e, 'border' + Ve[a] + 'Width', !0, o)))
    ...
    function z(e, t, n) {
        ...
        return (
            ((!be.boxSizingReliable() && i) ||
                ...
                ((i = 'border-box' === Ee.css(e, 'boxSizing', !1, r)), (a = u in e), a && (s = e[u])),
            (s = parseFloat(s) || 0),
    ...
    function U() {
        St &&
            (ue.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(U) : e.setTimeout(U, Ee.fx.interval),
            Ee.fx.tick());
    }
    function X() {
        return (
    ...
    function V(e, t, n) {
        ...
        if (((u = !Ee.isEmptyObject(t)), u || !Ee.isEmptyObject(p))) {
            f &&
                ...
                (c = Ee.css(e, 'display')),
                'none' === c &&
                    (l ? (c = l) : (x([e], !0), (l = e.style.display || l), (c = Ee.css(e, 'display')), x([e]))),
            ...
            for (r in p)
                u ||
                    (g ? 'hidden' in g && (m = g.hidden) : (g = ze.access(e, 'fxshow', { display: l })),
                    i && (g.hidden = !m),
                    m && x([e], !0),
                    d.done(function () {
    ...
    function K(e, t, n) {
        var r,
            ...
            u = function () {
                ...
                return (
                    ...
                    1 > i && u ? n : (u || s.notifyWith(e, [l, 1, 0]), s.resolveWith(e, [l]), !1)
                );
            },
            l = s.promise({
                elem: e,
        ...
        for (G(c, l.opts.specialEasing); a > i; i++)
            if ((r = K.prefilters[i].call(l, e, c, l.opts)))
                return xe(r.stop) && (Ee._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        return (
            Ee.map(c, Y, l),
    ...
    (Ee.fn = Ee.prototype =
                            ...
                            (r = e[t]),
                                '__proto__' !== t &&
                                    ...
                                    (l && r && (Ee.isPlainObject(r) || (o = Array.isArray(r)))
                                        ? ((n = a[t]),
                                          (i = o && !Array.isArray(n) ? [] : o || Ee.isPlainObject(n) ? n : {}),
                                          (o = !1),
                                          (a[t] = Ee.extend(l, i, r)))
                                        : void 0 !== r && (a[t] = r));
                return a;
        ...
        Ee.extend({
            ...
            each: function (e, t) {
                var n,
                    r = 0;
                if (o(e)) for (n = e.length; n > r && t.call(e[r], r, e[r]) !== !1; r++);
            ...
            map: function (e, t, n) {
                var r,
                    ...
                    a = 0,
                    s = [];
                if (o(e)) for (r = e.length; r > a; a++) (i = t(e[a], a, n)), null != i && s.push(i);
            ...
            if (!r && ((t ? t.ownerDocument || t : $) !== O && D(t), (t = t || O), P)) {
                ...
                if (C.qsa && !Q[e + ' '] && (!q || !q.test(e)) && (1 !== h || 'object' !== t.nodeName.toLowerCase())) {
                    if (((c = e), (d = t), 1 === h && fe.test(e))) {
                        for (
                            (s = t.getAttribute('id')) ? (s = s.replace(Te, Ee)) : t.setAttribute('id', (s = B)),
                                l = k(e),
                                i = l.length;
                            i--;
                ...
                r(function (r, a, s, u) {
                    ...
                    if (r) {
                        if (i || e) {
                            ...
                            for (c = b.length; c--; )
                                (f = b[c]) && (l = i ? te(r, f) : d[c]) > -1 && (r[l] = !(a[l] = f));
                        }
                ...
                if ((n = T.relative[e[s].type])) c = [h(m(c), n)];
                    ...
                    if (((n = T.filter[e[s].type].apply(null, e[s].matches)), n[B])) {
                        ...
                        return y(
                            s > 1 && m(c),
                            s > 1 &&
                                p(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(
                                    ue,
                                    '$1'
                                ),
                            n,
        ...
        (C = t.support = {}),
                          ...
                          (C.qsa = ye.test(O.querySelectorAll)) &&
                              ...
                              o(function (e) {
                                  ...
                                  t.setAttribute('type', 'hidden'),
                                      ...
                                      e.querySelectorAll('[name=d]').length && q.push('name' + re + '*[*^$|!~]?='),
            ...
            (t.matchesSelector = function (e, n) {
                if (
                    ...
                    C.matchesSelector && P && !Q[n + ' '] && (!M || !M.test(n)) && (!q || !q.test(n)))
                )
                    try {
                        var r = _.call(e, n);
            ...
            (k = t.tokenize =
                function (e, n) {
                    ...
                    for (s = e, u = [], l = T.preFilter; s; ) {
                        (r && !(o = le.exec(s))) || (o && (s = s.slice(o[0].length) || s), u.push((i = []))),
                            (r = !1),
                            (o = ce.exec(s)) &&
                                ((r = o.shift()),
            ...
            (N = t.select =
                function (e, t, n, r) {
                    ...
                    if (((n = n || []), 1 === c.length)) {
                        if (
                            ((i = c[0] = c[0].slice(0)),
                            i.length > 2 && 'ID' === (a = i[0]).type && 9 === t.nodeType && P && T.relative[i[1].type])
                        ) {
                        ...
                        for (
                            ...
                            if (
                                (u = T.find[s]) &&
                                (r = u(a.matches[0].replace(we, Ce), (xe.test(i[0].type) && f(t.parentNode)) || t))
                            ) {
    ...
    var Le,
        ...
        Oe = (Ee.fn.init = function (e, t, n) {
            ...
            if (((n = n || Le), 'string' == typeof e)) {
                if (
                    ((r = '<' === e[0] && '>' === e[e.length - 1] && e.length >= 3 ? [null, e, null] : De.exec(e)),
                    !r || (!r[1] && t))
                )
                ...
                if (r[1]) {
                    if (
                        ...
                        Ee.merge(this, Ee.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ue, !0)),
            ...
            if (!je.test(e))
                for (; o > r; r++)
                    for (n = this[r]; n && n !== t; n = n.parentNode)
                        if (
                            n.nodeType < 11 &&
                            (a ? a.index(n) > -1 : 1 === n.nodeType && Ee.find.matchesSelector(n, e))
                        ) {
                            i.push(n);
                            break;
                        }
        ...
        Ee.each(
            {
                ...
                contents: function (e) {
                    return 'undefined' != typeof e.contentDocument
                        ? e.contentDocument
                        : (i(e, 'template') && (e = e.content || e), Ee.merge([], e.childNodes));
                },
            },
            function (e, t) {
                Ee.fn[e] = function (n, r) {
                    ...
                    return (
                        ...
                        this.length > 1 && (Pe[e] || Ee.uniqueSort(o), He.test(e) && o.reverse()),
                        this.pushStack(o)
                    );
                };
            }
    ...
    (Ee.Callbacks = function (e) {
                ...
                remove: function () {
                    return (
                        Ee.each(arguments, function (e, t) {
                            for (var n; (n = Ee.inArray(t, a, n)) > -1; ) a.splice(n, 1), l >= n && l--;
                        }),
                        this
                    );
                },
        ...
        Ee.extend({
                        ...
                        then: function (t, r, o) {
                            function i(t, n, r, o) {
                                return function () {
                                    ...
                                    t
                                        ? d()
                                        : (Ee.Deferred.getStackHook && (d.stackTrace = Ee.Deferred.getStackHook()),
                                          e.setTimeout(d));
                                };
                            }
                            var a = 0;
            ...
            when: function (e) {
                ...
                if (
                    1 >= t &&
                    (f(e, i.done(a(n)).resolve, i.reject, !t), 'pending' === i.state() || xe(o[n] && o[n].then))
                )
                    return i.then();
        ...
        Ee.extend({
            ...
            ready: function (e) {
                (e === !0 ? --Ee.readyWait : Ee.isReady) ||
                    ((Ee.isReady = !0), (e !== !0 && --Ee.readyWait > 0) || _e.resolveWith(ue, [Ee]));
            },
        }),
        (Ee.ready.then = _e.then),
        'complete' === ue.readyState || ('loading' !== ue.readyState && !ue.documentElement.doScroll)
            ? e.setTimeout(Ee.ready)
            : (ue.addEventListener('DOMContentLoaded', d), e.addEventListener('load', d));
    ...
    (m.uid = 1),
        (m.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== r) {
                    if (void 0 !== t) {
                        Array.isArray(t) ? (t = t.map(h)) : ((t = h(t)), (t = t in r ? [t] : t.match(qe) || [])),
                            (n = t.length);
                        for (; n--; ) delete r[t[n]];
                    }
            ...
            data: function (e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && ((o = We.get(i)), 1 === i.nodeType && !ze.get(i, 'hasDataAttrs'))) {
                        for (n = a.length; n--; )
                            a[n] && ((r = a[n].name), 0 === r.indexOf('data-') && ((r = h(r.slice(5))), v(i, r, o[r])));
        ...
        Ee.extend({
            queue: function (e, t, n) {
                ...
                return e
                    ? ((t = (t || 'fx') + 'queue'),
                      (r = ze.get(e, t)),
                      n && (!r || Array.isArray(n) ? (r = ze.access(e, t, Ee.makeArray(n))) : r.push(n)),
                      r || [])
                    : void 0;
            },
        ...
        Ee.fn.extend({
            ...
            promise: function (e, t) {
                ...
                for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
                    (n = ze.get(i[a], e + 'queueHooks')), n && n.empty && (r++, n.empty.add(s));
    ...
    var Je = function (e, t) {
            return (
                (e = t || e),
                'none' === e.style.display || ('' === e.style.display && Ke(e) && 'none' === Ee.css(e, 'display'))
            );
        },
        et = function (e, t, n, r) {
            var o,
    ...
    (Ee.event = {
                ...
                for (
                    n.handler && ((i = n), (n = i.handler), (o = i.selector)),
                        ...
                        (a = g.handle) ||
                            (a = g.handle =
                                function (t) {
                                    return 'undefined' != typeof Ee && Ee.event.triggered !== t.type
            ...
            if (g && (u = g.events)) {
                for (t = (t || '').match(qe) || [''], l = t.length; l--; )
                    if (((s = lt.exec(t[l]) || []), (p = m = s[1]), (h = (s[2] || '').split('.').sort()), p)) {
                        ...
                        a &&
                            !d.length &&
                            ((f.teardown && f.teardown.call(e, h, g.handle) !== !1) || Ee.removeEvent(e, p, g.handle),
                            delete u[p]);
        ...
        dispatch: function (e) {
            ...
            if (((s.delegateTarget = this), !c.preDispatch || c.preDispatch.call(this, s) !== !1)) {
                for (a = Ee.event.handlers.call(this, s, l), t = 0; (o = a[t++]) && !s.isPropagationStopped(); )
                    for (s.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                        (s.rnamespace && i.namespace !== !1 && !s.rnamespace.test(i.namespace)) ||
                            ((s.handleObj = i),
                            (s.data = i.data),
                            (r = ((Ee.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)),
                ...
                ? (e && e.type
                      ? ((this.originalEvent = e),
                        ...
                        (this.isDefaultPrevented =
                            e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? E : S),
    ...
    Ee.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (i = i || w(e), a = a || w(s), r = 0, o = i.length; o > r; r++) O(i[r], a[r]);
                else O(e, s);
                    ...
                    function (e) {
                        ...
                        if ('string' == typeof e && !ft.test(e) && !it[(rt.exec(e) || ['', ''])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; r > n; n++)
                                    (t = this[n] || {}),
                                        1 === t.nodeType && (Ee.cleanData(w(t, !1)), (t.innerHTML = e));
                                t = 0;
                            } catch (o) {}
                        }
            ...
            function (e, t) {
                Ee.fn[e] = function (e) {
                    for (var n, r = [], o = Ee(e), i = o.length - 1, a = 0; i >= a; a++)
                        (n = a === i ? this : this.clone(!0)), Ee(o[a])[t](n), de.apply(r, n.get());
                ...
                return (
                    ...
                    void 0 === n
                        ? a && 'get' in a && void 0 !== (o = a.get(e, !1, r))
                            ...
                            : l[t]
                        : ((i = typeof n),
                          'string' === i && (o = Ye.exec(n)) && o[1] && ((n = y(e, t, o)), (i = 'number')),
                          null != n &&
                              n === n &&
                              ('number' !== i || u || (n += (o && o[3]) || (Ee.cssNumber[s] ? '' : 'px')),
                              be.clearCloneStyle || '' !== n || 0 !== t.indexOf('background') || (l[t] = 'inherit'),
            ...
            Ee.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    ...
                    return (
                        ...
                        l && (o = Ye.exec(n)) && 'px' !== (o[3] || 'px') && ((e.style[t] = n), (n = Ee.css(e, t))),
                        $(e, n, l)
                    );
                },
            };
            ...
            run: function (e) {
                ...
                return (
                    this.options.duration
                        ? (this.pos = t =
                              Ee.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration))
                        : (this.pos = t = e),
        ...
        (W.propHooks = {
            _default: {
                ...
                set: function (e) {
                    Ee.fx.step[e.prop]
                        ? Ee.fx.step[e.prop](e)
                        : 1 !== e.elem.nodeType || (!Ee.cssHooks[e.prop] && null == e.elem.style[B(e.prop)])
                        ? (e.elem[e.prop] = e.now)
    ...
    (Ee.Animation = Ee.extend(K, {
        ...
        (Ee.speed = function (e, t, n) {
            var r =
                e && 'object' == typeof e
                    ? Ee.extend({}, e)
                    : { complete: n || (!n && t) || (xe(e) && e), duration: e, easing: (n && t) || (t && !xe(t) && t) };
            return (
                Ee.fx.off
                    ? (r.duration = 0)
                ...
                return (
                    ...
                    this.each(function () {
                        var t,
                            ...
                            a = r ? r.length : 0;
                        for (
                            n.finish = !0, Ee.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = i.length;
                            t--;
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                    return 'undefined' == typeof e.getAttribute
                        ? Ee.prop(e, t, n)
                        : ((1 === i && Ee.isXMLDoc(e)) ||
                              (o = Ee.attrHooks[t.toLowerCase()] || (Ee.expr.match.bool.test(t) ? Nt : void 0)),
                          void 0 !== n
                              ? null === n
                ...
                if (o)
                    return (
                        ...
                        t && 'get' in t && void 0 !== (n = t.get(o, 'value'))
                            ? n
                            : ((n = o.value), 'string' == typeof n ? n.replace(Dt, '') : null == n ? '' : n)
                    );
            }
        },
    }),
        ...
        trigger: function (t, n, r, o) {
            ...
            if (
                ...
                if (!o && !f.noBubble && !we(r)) {
                    for (u = f.delegateType || h, Ot.test(u + h) || (a = a.parentNode); a; a = a.parentNode)
                        p.push(a), (s = a);
                ...
                for (i = 0; (a = p[i++]) && !t.isPropagationStopped(); )
                    (d = a),
                        ...
                        c && c.apply(a, n),
                        (c = l && a[l]),
                        c && c.apply && Fe(a) && ((t.result = c.apply(a, n)), t.result === !1 && t.preventDefault());
                return (
                    (t.type = h),
                    o ||
            ...
            ajax: function (t, n) {
                function r(t, n, r, s) {
                    ...
                    c ||
                        ...
                        y.fireWith(m, [T, C]),
                        f && (g.trigger('ajaxComplete', [T, h]), --Ee.active || Ee.event.trigger('ajaxStop')));
                }
                ...
                if (
                    (v.promise(T),
                    (h.url = ((t || h.url || Pt.href) + '').replace(Yt, Pt.protocol + '//')),
                ...
                if (
                    (h.data && h.processData && 'string' != typeof h.data && (h.data = Ee.param(h.data, h.traditional)),
                    re(Vt, h, n, T),
                    c)
                )
                    return T;
                (f = Ee.event && h.global),
                    ...
                    h.hasContent
                        ...
                        : ((p = h.url.slice(i.length)),
                          ...
                          h.cache === !1 &&
                              ((i = i.replace(Wt, '$1')), (p = (Mt.test(i) ? '&' : '?') + '_=' + qt++ + p)),
                          (h.url = i + p)),
                    h.ifModified &&
                        (Ee.lastModified[i] && T.setRequestHeader('If-Modified-Since', Ee.lastModified[i]),
                    ...
                    T.setRequestHeader(
                        ...
                        h.dataTypes[0] && h.accepts[h.dataTypes[0]]
                            ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + Kt + '; q=0.01' : '')
                            : h.accepts['*']
                    );
        ...
        Ee.each(['get', 'post'], function (e, t) {
            Ee[t] = function (e, n, r, o) {
                return (
                    ...
                    Ee.ajax(Ee.extend({ url: e, type: t, dataType: o, data: n, success: r }, Ee.isPlainObject(e) && e))
                );
            };
        }),
    ...
    Ee.ajaxSetup({
        ...
        Ee.ajaxPrefilter('json jsonp', function (t, n, r) {
            ...
            return s || 'jsonp' === t.dataTypes[0]
                ? ((o = t.jsonpCallback = xe(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                  s
                      ? (t[s] = t[s].replace(nn, '$1' + o))
                      : t.jsonp !== !1 && (t.url += (Mt.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
        ...
        (Ee.parseHTML = function (e, t, n) {
            ...
            return (
                ...
                o
                    ? [t.createElement(o[1])]
                    : ((o = T([e], t, i)), i && i.length && Ee(i).remove(), Ee.merge([], o.childNodes))
            );
        }),
                ...
                if (this[0]) {
                    ...
                    if ('fixed' === Ee.css(r, 'position')) t = r.getBoundingClientRect();
                        ...
                        for (
                            ...
                            e && (e === n.body || e === n.documentElement) && 'static' === Ee.css(e, 'position');
    ...
    (function (e) {
        ...
        (b.prototype = {
            ...
            parseEl: function (n) {
                var r,
                    o = t.items[n];
                if ((o.tagName ? (o = { el: e(o) }) : ((r = o.type), (o = { data: o, src: o.src })), o.el)) {
            ...
            addGroup: function (e, n) {
                ...
                (n.mainEl = e),
                    n.items
                        ...
                        : ((n.isObj = !1),
                          n.delegate ? e.off(o).on(o, n.delegate, r) : ((n.items = e), e.off(o).on(o, r)));
            },
                        ...
                        if (((o = n.split('_')), o.length > 1)) {
                            ...
                            if (i.length > 0) {
                                ...
                                'replaceWith' === a
                                    ...
                                    ? i.is('img')
                                        ? i.attr('src', r)
                                        : i.replaceWith(e('<img>').attr('src', r).attr('class', i.attr('class')))
                                    : i.attr(o[1], r);
                            }
                    ...
                    return (
                        ...
                        n.hasSize
                            ...
                            : (t.updateStatus('loading'),
                              (n.loading = !0),
                              n.hasSize || ((n.imgHidden = !0), r.addClass('mfp-loading'), t.findImageSize(n)),
                              r)
                    );
                },
            },
        ...
        e.magnificPopup.registerModule('zoom', {
            ...
            proto: {
                ...
                _getOffset: function (n) {
                    ...
                    var s = { width: r.width(), height: (x ? r.innerHeight() : r[0].offsetHeight) - a - i };
                    return (
                        B()
                            ...
                            ? ((i += ' mfp-gallery'),
                              ...
                              C('BuildControls' + o, function () {
                                  if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                                      var r = n.arrowMarkup,
                                          o = (t.arrowLeft = e(
                                              r.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, 'left')
                                          ).addClass(y)),
                                          i = (t.arrowRight = e(
                                              r.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, 'right')
                                          ).addClass(y));
                                      o.click(function () {
                                          t.prev();
                                      }),
        ...
        (r.throttle = n =
            function (e, n, o, i) {
                function a() {
                    ...
                    i && !s && r(),
                        s && clearTimeout(s),
                        i === t && c > e ? r() : n !== !0 && (s = setTimeout(i ? a : r, i === t ? e - c : e));
                }
                var s,
                    u = 0;
                return (
        ...
        var t = {
            ...
            s = function (e, t) {
                ...
                return (
                    ...
                    'easeInOutQuad' === e.easing && (n = 0.5 > t ? 2 * t * t : -1 + (4 - 2 * t) * t),
                    ...
                    'easeInOutQuart' === e.easing && (n = 0.5 > t ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t),
                ...
                if (history.replaceState && t.updateURL && !history.state) {
                    ...
                    (n = n ? n : ''),
                        history.replaceState(
                            { smoothScroll: JSON.stringify(t), anchor: n ? n : e.pageYOffset },
                            document.title,
                            n ? n : e.location.href
                        );
                }
            ...
            m = function (t, n, r, o) {
                if (n.emitEvents && 'function' == typeof e.CustomEvent) {
                    var i = new CustomEvent(t, { bubbles: !0, detail: { anchor: r, toggle: o } });
            ...
            g = function (i, g) {
                ...
                (T.cancelScroll = function (e) {
                    ...
                    (T.animateScroll = function (n, i, a) {
                        ...
                        if (g || y) {
                            ...
                            var w,
                                ...
                                A = g
                                    ...
                                    : l(
                                          y,
                                          k,
                                          parseInt('function' == typeof d.offset ? d.offset(n, i) : d.offset, 10),
                                          d.clip
                                      ),
                                N = A - b,
                                j = u(),
                            ...
                            m('scrollStart', d, n, i), T.cancelScroll(!0), e.requestAnimationFrame(O);
                        }
                    });
                var E = function (t) {
                        if (
                    ...
                    S = function (e) {
                        if (
                            ...
                            ('string' == typeof t && t && !(t = document.querySelector(a(history.state.anchor)))) ||
                ...
                var k = function () {
                    ...
                    T.destroy(),
                        ...
                        v.updateURL && v.popstate && e.addEventListener('popstate', S, !1);
                };
                return k(), T;
            };
        return g;
        ...
        var t = {
            ...
            u = function (t, n, r) {
                var o = t.getBoundingClientRect(),
                    i = a(n);
                return r
                    ? parseInt(o.bottom, 10) < (e.innerHeight || document.documentElement.clientHeight)
                    : parseInt(o.top, 10) <= i;
            },
            l = function () {
            ...
            f = function (e, t) {
                var n = e[e.length - 1];
                if (c(n, t)) return n;
                for (var r = e.length - 1; r >= 0; r--) if (u(e[r].content, t)) return e[r];
            },
            d = function (e, t) {
                if (t.nested) {
            ...
            p = function (e, t) {
                if (e) {
                    ...
                    n &&
                        ...
                        d(n, t),
                        r('gumshoeDeactivate', n, { link: e.nav, content: e.content, settings: t }));
                }
            },
            h = function (e, t) {
                if (t.nested) {
            ...
            m = function (e, t) {
                if (e) {
                    ...
                    n &&
                        ...
                        h(n, t),
                        r('gumshoeActivate', n, { link: e.nav, content: e.content, settings: t }));
                }
            },
            g = function (r, o) {
                var a,
                ...
                (d.setup = function () {
                    ...
                    (d.detect = function () {
                        var e = f(s, c);
                        return e
                            ? void ((u && e.content === u.content) || (p(u, c), m(e, c), (u = e)))
                            : void (u && (p(u, c), (u = null)));
                    });
                var h = function (t) {
